                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            <li><i class="fa fa-id-badge"></i><a href="penerbit.php">Penerbit</a></li>                            
                            <li><i class="fa fa-book"></i><a href="buku.php">Buku</a></li>
                        </ul>
                    </li>                   
                </ul>
            </div><!-- /.navbar-collapse -->
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php"><img src="img/book.jpg" width="45" alt="Logo"></a>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    foreach ($buku as $buku) {
                                                        ...
                                                        INNER JOIN penerbit ON buku.penerbit_id=penerbit.id WHERE penerbiit_id";
                                                    }
                                                    ?>
                                                    ...
                                                    <td><?= $buku['kategori'] ?> </td>
                                                    <td>  <span class="name"> <?= $buku['nama_buku'] ?> </span> </td>
                                                    <td> <span class="harga">  <?= $buku['harga'] ?> </span> </td>
                                                    <td><span class="count"> <?= $buku['stok'] ?> </span></td>
                                                    <td>
                                                        <?= $buku['penerbit_id'] ?>
                                                    </td>
                                                    <td>
                                                        <a href="#" class="btn icon btn-primary"><i class="fa fa-eye"></i></a>
