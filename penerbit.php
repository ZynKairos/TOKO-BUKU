                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Penerbit</a></li>                            
                            <li><i class="fa fa-book"></i><a href="ui-switches.html">Buku</a></li>
                        </ul>
                    </li>                   
                </ul>
            </div><!-- /.navbar-collapse -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    foreach ($penerbit as $pen) {
                                                        $id = $pen['id'];
                                                        $query = "SELECT penerbit.* FROM penerbit";                                                        
                                                    }
                                                    ?>
